package org.k11techlab.framework.selenium.webuitestengine.k11CustomDataProvider.Impl;
...
import org.k11techlab.framework.selenium.webuitestengine.k11CustomDataProvider.ExcelDataProvider;
import org.k11techlab.framework.selenium.webuitestengine.k11CustomDataProvider.filter.DataProviderFilter;
import org.k11techlab.framework.selenium.webuitestengine.k11CustomDataProvider.helper.DataProviderHelper;
 ...
 *
 * The first column is reserved for keys which are not part of the actual test data.
...
public class ExcelDataProviderImpl implements ExcelDataProvider {
    ...
    private Map<String, String> prepareHeaderRowDataMap(List<String> header, List<String> rowData) {
        ...
        if (header.size() == rowData.size()) {
            ...
            Log.debug("header and columns are not of same size");
        }
